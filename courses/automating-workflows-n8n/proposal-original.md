...
This two-day programme introduces participants to n8n, a powerful open-source workflow automation platform, equipping them with the practical skills to design, build, and manage automated workflows. Through a combination of concept-led sessions and hands-on labs, participants will learn to connect applications, process data, handle errors, and integrate AI agents — including n8n's native AI Workflow Builder and MCP (Model Context Protocol) ecosystem — to reduce reliance on manual processes and improve operational efficiency across their teams.
...
- Google Workspace account (Gmail, Sheets — for integration exercises)
- OpenAI API key or Anthropic API key (for AI Agent and AI Workflow Builder modules)
- Claude Desktop or ChatGPT (optional — for MCP server demo in Hour 12)
